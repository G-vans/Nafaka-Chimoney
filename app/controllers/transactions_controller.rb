class TransactionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transaction.save
        #send_sms
        send_money_via_chimoney(@transaction.investment.amount)
        format.html { redirect_to invest_success_url, notice: "Transaction was successfully created." }
  ...
  def send_sms
    ...
    def send_money_via_chimoney(amount)
      require 'uri'
      require 'net/http'
      ...
      request["content-type"] = 'application/json'
      request["X-API-KEY"] = 'bdf360cd6f2b0435d90395368225b5cde1cd376466c281c1af2b1c707a41205e'
      # request.body = "{\"subAccount\":\"dae06145-e1c8-4485-be0d-d00f2623c021\",\"momos\":[{\"momoCode\":\"MPX\",\"valueInUSD\":#{amount},\"phoneNumber\":\"#{phone_number}\",\"countryToSend\":\"Kenya\"}]}"
      request.body = "{\"chimoneys\":[{\"payerEmail\":\"otienostan96@gmail.com\",\"valueInUSD\":#{amount}}]}"
